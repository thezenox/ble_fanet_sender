...
public:
  ...
  */
  ...
  ~FanetLora();
  bool begin(int8_t sck, int8_t miso, int8_t mosi, int8_t ss,int8_t reset, int8_t dio0, int8_t gpio,long frequency,uint8_t outputPower,uint8_t radio, MacAddr addr);
  void end(void);
  ...
  void sendGroundTracking(trackingData *tData);
